...
private:
    ...
    int size_; // number of contents of array
    int capacity_; // size of internal array 
	int headroom_; //headroom in internal array
	int tailroom_; //tailroom in internal array
	void resize_and_center_(); // for resizing and recentering internal array
